  ...
  messages: {
    ...
    ru: {
      ...
      "settings": {
        ...
        "doctor_description": "Пока доктор в чате, он имеет шанс заменить новые сообщения пользователей на перемешанный набор букв (удаляет сообщение и пишет его сам, автор сообщения будет утерян)",
