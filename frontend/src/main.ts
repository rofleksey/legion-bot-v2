  ...
  messages: {
    en: {
      ...
      "settings": {
        ...
        "ghostface_description": "Marks users who send messages. If during any of the next rounds the Ghost Face sees a message from a marked user, he 'kills' them and 'hooks' them (the user gets a timeout). Comes for a fixed amount of time, silently marks users and leaves. Always reports the number of users who were marked in this round before leaving.",
        "fatal_hit": "Fatal Hit",
    ...
    ru: {
      ...
      "settings": {
        ...
        "ghostface_description": "Помечает пользователей, которые отправляют сообщения. Если в любом следующем раунде Крик увидит сообщение от помеченного пользователя, он 'убивает' его и 'вешает на крюк' (пользователь получает таймаут). Приходит на фиксированное время, молча помечает пользователей и уходит. Перед уходом всегда сообщает количество пользователей, которые были помечены в этом раунде.",
        ...
        "min_delay_between_hits": "Мин. задержка между ударами",
