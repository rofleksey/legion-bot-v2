  ...
  messages: {
    en: {
      ...
      "settings": {
        ...
        "ghostface_description": "Marks users who send messages. The next time the Ghost Face comes and sees a message from a marked user, he 'kills' them and 'hooks' them (the user gets a timeout). Comes for a fixed amount of time, silently marks users and leaves. Always reports the number of users who were marked in this round before leaving.",
        "fatal_hit": "Fatal Hit",
